...
class AdamW(Optimizer):
    ...
    param_descriptions = {
        "lr": "скорость обучения — масштаб шага (умножается и на weight_decay)",
        ...
        "weight_decay": "отвязанная от градиента регуляризация: каждый шаг тянет точку к началу координат, смещая минимум",
    }
