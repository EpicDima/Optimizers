...
class Lion(Optimizer):
    ...
    param_descriptions = {
        "lr": "скорость обучения; из-за sign шаг по каждой оси всегда имеет длину lr",
        "beta1": "вес момента при интерполяции текущего градиента и момента для выбора направления шага",
        "beta2": "коэффициент EMA момента — скорость обновления памяти о прошлых градиентах",
