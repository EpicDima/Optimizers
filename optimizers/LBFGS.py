...
class LBFGS(Optimizer):
    ...
    param_descriptions = {
        "lr": "начальная длина пробного шага линейного поиска вдоль квазиньютоновского направления",
        "history_size": "число хранимых пар (s, y) для двухцикловой аппроксимации обратного гессиана",
        "c1": "коэффициент условия Армихо — требуемая доля предсказанного убывания функции",
        "tau": "множитель уменьшения шага при откате (backtracking) в линейном поиске",
        "max_ls_steps": "максимум уменьшений шага в линейном поиске; если шаг не найден — остаёмся на месте",
    }
