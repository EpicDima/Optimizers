...
class ASGD(Optimizer):
    ...
    param_descriptions = {
        "lr": "начальная скорость обучения; эффективный шаг eta затухает с ростом номера итерации",
        "lambd": "коэффициент затухания: сжимает точку на каждом шаге и ускоряет убывание eta",
        "alpha": "степень в законе убывания шага eta = lr / (1 + lambd*lr*t)^alpha",
        "t0": "номер шага, начиная с которого усредняется траектория (усреднённая точка Поляка)",
