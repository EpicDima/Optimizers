...
class Sophia(Optimizer):
    ...
    param_descriptions = {
        ...
        "beta2": "коэффициент EMA диагонали гессиана (оценка кривизны; отрицательная кривизна обрезается нулём)",
        "rho": "порог покомпонентного клиппинга шага — максимальная длина шага по оси равна lr * rho",
        "eps": "нижний порог оценки кривизны h в знаменателе — численная защита",
    }
