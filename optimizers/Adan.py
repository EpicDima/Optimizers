...
class Adan(Optimizer):
    ...
    param_descriptions = {
        ...
        "beta1": "коэффициент EMA самого градиента (первый момент m)",
        "beta2": "коэффициент EMA разности соседних градиентов и её вес в Nesterov-поправке шага",
        "beta3": "коэффициент EMA квадрата скорректированного градиента — адаптивный масштаб шага",
