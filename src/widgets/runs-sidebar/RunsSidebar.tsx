      ...
      <Panel heading="Запуск" className="shrink-0">
        <div className="flex flex-col gap-2 p-3">
          ...
          <NumberField
            ...
            description="Имитация обучения на мини-батчах: в реальных задачах градиент зашумлён, потому что считается по выборке, а не по всему датасету. σ — стандартное отклонение гауссова шума к f(x,y). Лёгкий шум: 1e-5–1e-4, сильный: 1e-3–1e-2 (адаптивные оптимизаторы вроде Adam справляются и с сильным)."
          />
