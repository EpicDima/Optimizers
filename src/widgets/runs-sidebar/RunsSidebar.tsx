      ...
      <Panel heading="Запуск" className="shrink-0">
        <div className="flex flex-col gap-2 p-3">
          ...
          <NumberField
            ...
            description="Имитация обучения на мини-батчах: в реальных задачах градиент зашумлён, потому что считается не по всему датасету, а по небольшой выборке. σ — стандартное отклонение гауссова шума к f(x,y). Типичные значения: 1e-7–1e-5. Значения ≥0.01 забивают градиент."
          />
